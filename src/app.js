...
function createGame() {
  ...
  function renderMole(mole) {
    switch (mole.state) {
      ...
      case "hungry":
        mole.src = mole.isKing
          ? "../public/images/kingmolehungry.png"
          : "../public/images/molehungry.png";
        mole.display = "block";
        break;

      case "fed":
        mole.src = mole.isKing
          ? "../public/images/kingmolefed.png"
          : "../public/images/molefed.png";
        break;

      case "sad":
        mole.src = mole.isKing
          ? "../public/images/kingmolesad.png"
          : "../public/images/molesad.png";
        break;

      case "leaving":
        mole.src = mole.isKing
          ? "../public/images/kingmoleleaving.png"
          : "../public/images/moleleaving.png";
        break;
    }
  }
